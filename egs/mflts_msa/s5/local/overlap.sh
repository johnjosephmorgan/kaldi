...
# the name of a randomly chosen file 
a=$(find $dir/*/audio_threshold/*/wavs/* -type f -name "*.wav" | shuf -n 1)
#echo "a $a"

# get the name of another randomly chosen file from the samples files
b_samples=$(find $dir/*/audio_threshold/*/infos -type f -name "*_samples.txt" | shuf -n 1)
