...
# weights set to 0.70 0.30
# The mls task is trained on 50 k utterances or 206 hours of speech
...
if [ $stage -le 0 ]; then
  ...
  (
    ...
    cd data/mls_fr
    [ -L lang ] || ln -s ../../../../mls_fr/s5d/data/lang ./;
    [ -L lang_test ] || ln -s ../../../../mls_fr/s5d/data/lang_test ./;
    [ -L train ] || ln -s ../../../../mls_fr/s5d/data/train_50k ./train;
  )
  ...
  (
    ...
    cd exp/mls_fr
    [ -L tri3b ] || ln -s ../../../../mls_fr/s5d/exp/tri3b ./;
    [ -L tri3b_ali ] || ln -s ../../../../mls_fr/s5d/exp/tri3b_ali ./;
  )
fi
