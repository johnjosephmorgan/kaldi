...
# qc_make_lists.pl - write lists for acoustic model training
# writes files under data/local/tmp/srica/qc/lists
...
Example:
$0 /mnt/corpora/sri_canada/afc-qc_read.sentid.orig
"
}
...
my $tmpdir = "data/local/tmp/srica/qc";

my ($dir) = @ARGV;

my $d = "$dir/qc_dc_aug2016/audio/clean1";
my $p = "$dir/afc-qc_read.sentid.orig";
