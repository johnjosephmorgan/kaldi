...
# writes files under data/local/tmp/gabonread/lists
...
Example:
$0 /mnt/corpora/central_accord/train
"
}
...
my $tmpdir = "data/local/tmp/gabonread";

my ($d) = @ARGV;

my $p = "conf/gabon_read/transcripts_train_conditioned.tsv";
