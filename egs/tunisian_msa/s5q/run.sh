...
# Uses GALE and ARL training text to train the LM.
# Uses the large lexicon.
...
if [ $stage -le 0 ]; then
  (
    ...
    [ -L lang ] || ln -s ../../../s5o/data/lang ./;
    # link the train directory
    [ -L train ] || ln -s ../../../s5o/data/train ./;
    # link the devtest directory
    [ -L devtest ] || ln -s ../../../s5o/data/devtest ./;
    # link the test directory
    [ -L test ] || ln -s ../../../s5o/data/test ./;
    # link the lang_test directory
    [ -L lang_test ] || ln -s ../../../s5o/data/lang_test ./;
  )
  ...
  (
    ...
    [ -L tri3b ] || ln -s ../../../s5o/exp/tri3b ./;
    # link the tri3b_ali
    [ -L tri3b_ali ] || ln -s ../../../s5o/exp/tri3b_ali ./;
  )
...
if [ $stage -le 1 ]; then
  for lang in ${lang_list[@]}; do
    echo "$0: Speed perturbing $lang training data."
    ...
    echo "$0: Get alignments for perturbed $lang training data."
    ...
    echo "$0: Extract high resolution 40dim MFCCs."
...
if [ $stage -le 4 ]; then
  echo "$0: Train a diagonal universal background model."
  ...
  for f in devtest test; do
    ...
    (
      ...
      steps/nnet3/decode.sh \
        ...
        $tree_dir/graph \
        data/tunisian_msa/${f}_hires \
        exp/chain2_multi/tunisian_msa/decode_${f}_hires_GALE_LM_large_lexicon || exit 1
    )
  done
fi
