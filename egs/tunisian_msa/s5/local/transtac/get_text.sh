...
twoway_dir=$transtac_tmpdir/train/twoway
tmp_twoway_appen_train_2006_dir=$twoway_dir/appen/2006
tmp_twoway_appen_train_2007_dir=$twoway_dir/appen/2007
tmp_twoway_detroit_train_2006_dir=$twoway_dir/detroit/2006
tmp_twoway_dli_train_2006_dir=$twoway_dir/dli/2006
tmp_twoway_nist_train_2007_dir=$twoway_dir/nist/2007
tmp_twoway_pendleton_train_2005_dir=$twoway_dir/pendleton/2005
tmp_twoway_san_diego_train_2006_dir=$twoway_dir/san_diego/2006

echo "$0: Getting a list of the TRANSTAC 2way training appen 2006 transcript files."
...
echo "$0: Consolidating text files."
find $twoway_dir -type f -name "text" | xargs cat > $twoway_dir/text
