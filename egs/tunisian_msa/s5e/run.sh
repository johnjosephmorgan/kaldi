...
# chain2 recipe for  Tunisian MSA, mini_librispeech,  heroico and wsj.
...
# This script assumes the following 5 recipes have been run:
...
egs_dir_list="$dir/tunisian_msa_processed_egs $dir/mini_librispeech_processed_egs $dir/heroico_processed_egs $dir/wsj_processed_egs $dir/sprakbanken_processed_egs"
