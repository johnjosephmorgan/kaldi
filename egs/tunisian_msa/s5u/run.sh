...
# GALE is trained on 215 hours of speech or 100k utterances
...
if [ $stage -le 0 ]; then
  ...
  (
    ...
    cd data/gale_arabic
    [ -L lang ] || ln -s ../../../../gale_arabic/s5e/data/lang ./;
    [ -L lang_test ] || ln -s ../../../../gale_arabic/s5e/data/lang_test ./;
    [ -L train ] || ln -s ../../../../gale_arabic/s5e/data/train ./;
  )
  ...
  (
    ...
    cd exp/gale_arabic
    [ -L tri3b ] || ln -s ../../../../gale_arabic/s5e/exp/tri3b ./;
    [ -L tri3b_ali ] || ln -s ../../../../gale_arabic/s5e/exp/tri3b_ali ./;
  )
...
if [ $stage -le 22 ]; then
  local/gale_train_lms_utf8.sh \
    ../../gale_arabic/s5e/data/train/text \
    ../../gale_arabic/s5e/data/local/dict/lexicon.txt \
