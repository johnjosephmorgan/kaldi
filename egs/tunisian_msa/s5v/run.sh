...
# GALE is trained on    30k utterances
...
if [ $stage -le 0 ]; then
  ...
  (
    ...
    cd exp/gale_arabic
    [ -L tri3b ] || ln -s ../../../../gale_arabic/s5f/exp/tri3b ./;
    [ -L tri3b_ali ] || ln -s ../../../../gale_arabic/s5f/exp/tri3b_ali ./;
  )
...
if [ $stage -le 22 ]; then
  local/gale_train_lms_utf8.sh \
    ../../gale_arabic/s5f/data/train/text \
    ../../gale_arabic/s5f/data/local/dict/lexicon.txt \
