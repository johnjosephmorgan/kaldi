...
# make_lists_answers.pl - make acoustic model training lists
...
example:
$0 /mnt/disk01/Libyan_MSA_ARL/adel/data/transcripts/answers/adel_answers.tsv adel libyan
";
}
...
my $tmp_dir = "data/local/tmp/$l/test/answers/$spk";
