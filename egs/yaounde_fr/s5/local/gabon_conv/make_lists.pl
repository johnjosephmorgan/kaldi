...
# writes files under data/local/tmp/gabonconv/lists
...
my $tmpdir = "data/local/tmp/gabonconv";

my ($d) = @ARGV;

my $p = "$d/transcripts/train/gabon_conv/transcripts.txt";
