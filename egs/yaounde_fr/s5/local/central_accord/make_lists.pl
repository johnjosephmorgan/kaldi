...
# writes files under data/local/tmp/centralaccord/lists
...
Example:
$0 /mnt/corpora/central_accord/test
"
}
...
my $tmpdir = "data/local/tmp/centralaccord";

my ($d) = @ARGV;

my $p = "conf/central_accord/ca16_fn_transcript.tsv";
