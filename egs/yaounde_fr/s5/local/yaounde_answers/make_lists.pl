...
# writes files under data/local/tmp/yaounde/answers/lists
# The label files are only rough transcripts of the recordings.
# They were obtained automatically from a supervised system.
