...
# Copyright 2020  Johnh Morgan (ARL)
# Apache 2.0.

# This script does nnet3-based speech activity detection.
# It takes an input kaldi data directory and outputs an speech segment RTTM file.
...
if [ $# -ne 3 ]; then
  ...
  echo " e.g.: $0 data/dev-1 exp/segmentation_1a/tdnn_lstm_sad_1a exp/segmentation_1a/dev"-1_sad
  echo ""
  echo "Options: "
...
sad_dir=${out_dir} # working directory
